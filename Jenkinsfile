	...
	stages
	{
		...
		stage ('deploying war on slave-1')
		{
			...
			{	
				...
				sh "scp -i /root/aws-keypair-1.pem  /root/.jenkins/workspace/Assignment-2/gameoflife-web/target/gameoflife.war ec2-user@172.31.44.255:/home/ec2-user/apache-tomcat-9.0.67/webapps/"
			}
		}
